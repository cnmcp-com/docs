...
- **[Qdrant](https://github.com/qdrant/mcp-server-qdrant/)** - 使用 Qdrant 向量搜索引擎实现语义内存
...
> **注意：** 社区服务器未经测试，使用风险自负。它们与 Anthropic 无关或未获得其认可。
...
要使用 MCP 服务器与 Claude，将其添加到您的配置中：
...
访问我们的 [GitHub 讨论](https://github.com/orgs/modelcontextprotocol/discussions) 以参与 MCP 社区。 
